...
export default function AccountBookingsPage() {
  ...
  const handleUpdateBooking = async () => {
    ...
    if (!editSelectedSlotKey) { setEditBookingError("Please select an available time slot."); return; }
