    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PATCH, "/api/adminticket/tickets/*/reject").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/adminticket/tickets/*/reject").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PATCH, "/api/admin/tickets/*/reject").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/admin/tickets/*/reject").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.DELETE, "/api/bookings/admin/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/bookings/admin/checkin/**").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/api/tickets/technician/assigned").hasAnyRole("TECHNICIAN", "ADMIN")
